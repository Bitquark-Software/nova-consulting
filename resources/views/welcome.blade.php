    ...
    <body class="bg-[#F2F2F2] text-[#2C2C2C]">
            ...
            @if (Route::has('login'))
                <nav class="flex items-center justify-around gap-4 py-4 px-3">
                    ...
                    <div class="hidden rounded-2xl bg-transparent md:grid grid-cols-3 gap-1">
                        <div class="rounded-full border border-[#2C2C2C] text-[#2C2C2C] hover:bg-[#2C2C2C] hover:text-[#F2F2F2] px-6 py-2.5 text-center bg-transparent backdrop-blur-xl">
                            Services
                        </div>
                        <div class="rounded-full border border-[#2C2C2C] text-[#2C2C2C] hover:bg-[#2C2C2C] hover:text-[#F2F2F2] px-6 py-2.5 text-center bg-transparent backdrop-blur-xl">
                            Pricing
        ...
        <main class="block w-full">
            ...
            <div class="max-w-md md:max-w-2xl flex flew-row items-center justify-center mx-auto gap-3 p-4">
                ...
                <a href="#" class="p-4 bg-[#F2F2F2] text-[#2C2C2C] rounded-xl hover:shadow-2xl hover:bg-[#2C2C2C] hover:text-[#F2F2F2] border-[#2C2C2C] transition-all ease-in-out duration-200">Book a call</a>
            </div>
