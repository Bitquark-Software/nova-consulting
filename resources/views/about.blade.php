        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-12 mb-16">
                <div class="group hover:shadow-2xl transition-all duration-500 overflow-hidden border border-[#333]/50 hover:border-[#fff]/30 rounded-lg p-6">
                    <h2 class="text-3xl font-bold mb-4 text-[#2C2C2C]">Our Mission</h2>
                    <p class="text-gray-600 leading-relaxed">
                        We are dedicated to delivering cutting-edge IT solutions that drive business growth and digital transformation. Our team of experts combines technical excellence with strategic thinking to solve complex challenges and create lasting value for our clients.
                    </p>
                </div>

                <div class="group hover:shadow-2xl transition-all duration-500 overflow-hidden border border-[#333]/50 hover:border-[#fff]/30 rounded-lg p-6">
                    <h2 class="text-3xl font-bold mb-4 text-[#2C2C2C]">Our Vision</h2>
                    <p class="text-gray-600 leading-relaxed">
                        To be the leading technology partner that transforms businesses through innovation, excellence, and unwavering commitment to client success. We envision a future where technology seamlessly integrates with business goals to create exceptional outcomes.
                    </p>
                </div>
            </div>
    ...
    <!-- <section id="contact" class="relative py-20 px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-12">
                <div>
                    <h3 class="text-2xl font-bold mb-6 text-purple-400">Contact Information</h3>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400">contact@itsolutions.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="font-semibold text-gray-200">Address</p>
                                <p class="text-gray-400">123 Tech Street, Silicon Valley, CA 94025</p>
                            </div>
                        </div>
                    </div>

                    <div class="mt-8">
                        <h4 class="text-lg font-semibold mb-4 text-gray-200">Business Hours</h4>
