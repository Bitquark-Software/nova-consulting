...
<body class="min-h-screen bg-[#F2F2F2] text-[#2C2C2C]">
    {{-- 
      Ensure your layout includes the 'x-cloak' style. 
      If not, add this strictly for this view to prevent stepper flickering. 
    --}}
                ...
                <form @submit.prevent="submitForm">
                        ...
                        <div x-show="form.service === 'recruitment'">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2 space-y-1">
                                    ...
                                    <input type="text" x-model="form.recruit.stack" required placeholder="e.g. PHP, Laravel, React" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-black focus:ring-black sm:text-sm">
                                </div>
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input required type="number" x-model="form.recruit.budget" class="block w-full rounded-lg border-gray-300 pl-7 focus:border-black focus:ring-black sm:text-sm" placeholder="0.00" min="0">
                                    </div>
                                </div>
                    ...
                    <div class="mt-10 pt-6 border-t border-gray-100 flex justify-between items-center">
                        <button type="button" 
                            ...
                            <svg class="mr-2 -ml-1 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" /></svg>
                        ...
                        <div class="ml-auto">
                            <button type="button" 
                                ...
                                <svg class="ml-2 -mr-1 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                            </button>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('quotationWizard', () => ({
                step: 1,
                form: {
                    name: '', company: '', email: '', phone: '', referral: '',
                    service: '', 
                ...
                submitForm() {
                    // Filament usually prefers Livewire for form submission, 
                    // but if this is a raw Blade view, post via axios/fetch:
                    console.log('Submitting:', JSON.parse(JSON.stringify(this.form)));
