...
return [
    ...
    'editorial' => [
        ...
        'seo_description' => 'Perspectivas editoriales sobre software, diseño y productos digitales con claridad.',
        'seo_keywords' => 'blog software, desarrollo, nova consulting blog',
        'hero_title' => 'Toda la información digna de deployar.',
        'hero_subtitle' => '¡Extra! Hotfixes de última hora, notas de versión y columnistas que compilan a la primera—sin muro de pago para el criterio técnico.',
        'archives_title' => 'Archivo',
        'view_all' => 'VER TODO',
        'empty_featured' => 'Aún no hay artículos publicados. Vuelve pronto.',
        'no_archives' => 'Más artículos aparecerán aquí conforme crezca el archivo.',
        'back_home' => 'Inicio',
        'back_to_blog' => 'Volver al blog',
        'all_posts' => 'Todos los posts',
        'article_nav_aria' => 'Acciones del artículo',
        'sidebar_title' => 'Más lecturas',
        'sidebar_filename' => 'posts_relacionados.php',
        'sidebar_comment' => '// Relacionados por etiquetas — abre un slug para seguir leyendo',
        'sidebar_empty_comment' => '// La rama no tiene más commits',
        'sidebar_empty_exception' => 'NotFoundHttpException',
        'sidebar_empty_message' => '404: No hay más artículos en esta rama. EOF alcanzado.',
        'sidebar_empty_hint' => 'git checkout main — o regresa a',
        'sidebar_empty_link' => '/blog',
        'footer_brand' => 'Nova Consulting',
        'footer_archives' => 'Archivo',
        'footer_contact' => 'Contacto',
        'footer_services' => 'Servicios',
        'footer_copyright' => '© :year Nova Consulting. Todos los derechos reservados.',
    ],
];
